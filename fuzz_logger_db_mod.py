...
class FuzzLoggerDb(ifuzz_logger_backend.IFuzzLoggerBackend):
    ...
    def __init__(self, db_filename, num_log_cases=0):
        ...
        self._db_cursor.execute("""CREATE TABLE IF NOT EXISTS cases (name text, number integer, timestamp TEXT)""")
        self._db_cursor.execute(
            """CREATE TABLE IF NOT EXISTS steps (test_case_index integer, type text, description text, data blob,
