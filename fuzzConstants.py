...
CLOSE_MSG_TYPE_ID = 452
    #callback related
CLOSE_MSG_SEC_CH_ID_PRIM_NAME = 'secure channel id'
CLOSE_MSG_SEC_TOKEN_ID_PRIM_NAME = 'secure token id'
CLOSE_MSG_SEC_SEQ_NUM_PRIM_NAME = 'secure sequence number'
CLOSE_MSG_SEC_REQ_ID_PRIM_NAME = 'secure request id'
CLOSE_MSG_SEC_CH_ID_NODE_FIELD = CLOSE_MSG_NAME + "." + CLOSE_MSG_BODY_NAME + "." + CLOSE_MSG_SEC_CH_ID_PRIM_NAME
CLOSE_MSG_TOKEN_ID_NODE_FIELD = CLOSE_MSG_NAME + "." + CLOSE_MSG_BODY_NAME + "." + CLOSE_MSG_SEC_TOKEN_ID_PRIM_NAME
CLOSE_MSG_SEQ_NUM_NODE_FIELD = CLOSE_MSG_NAME + "." + CLOSE_MSG_BODY_NAME + "." + CLOSE_MSG_SEC_SEQ_NUM_PRIM_NAME
CLOSE_MSG_SEQ_REQ_ID_NODE_FIELD = CLOSE_MSG_NAME + "." + CLOSE_MSG_BODY_NAME + "." + CLOSE_MSG_SEC_REQ_ID_PRIM_NAME
